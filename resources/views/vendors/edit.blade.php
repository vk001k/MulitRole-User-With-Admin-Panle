...
@section('content')
    <div class="container-fluid">
        ...
        @endforeach
        <form action="{{url('vendors/update',$user->id)}}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                <input class="form-control" name="email" placeholder="Email" value="{{$user->email}}" disabled required>
                @error('email')
                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
            ...
            <div class="form-group">
                <input name="store_name" class="form-control" placeholder="Store Name"
                       value="{{$user->vendorDetails->store_name}}" required>
                @error('store_name')
                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
            ...
            <div class="form-group">
                <textarea name="store_address" class="form-control" placeholder="Store Address"
                          required>{{$user->vendorDetails->store_address}}</textarea>
                @error('store_address')
                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
            ...
            <div class="form-group">
                <textarea name="store_description" class="form-control" placeholder="Store Description"
                          required>{{$user->vendorDetails->store_description}}</textarea>
            ...
            <div class="form-group">
                <input name="contact_number" type="text" class="form-control" placeholder="Contact Number"
                       value="{{$user->vendorDetails->contact_number}}" required>
            ...
            <div class="form-group">
                <input name="phone_number" type="text" class="form-control" placeholder="Phone Number"
                       value="{{$user->vendorDetails->phone_no}}" required>
                @error('phone_number')
                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
